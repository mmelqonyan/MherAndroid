...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    MyAdapter(MainActivity mainActivity, List<RecyclerItem> list) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder { // extends RecyclerView.ViewHolder implements View.OnClickListener {
